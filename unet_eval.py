...
from deeplab_train import load_data
...
if __name__ == "__main__":
    ...
    create_dir("results_unet")

    """ Loading model """
    with CustomObjectScope({'iou': iou, 'dice_coef': dice_coef, 'dice_loss': dice_loss}):
        model = tf.keras.models.load_model("files_unet\\model_unet.h5")
    ...
    for x, y in tqdm(zip(test_x, test_y), total=len(test_x)):
        ...
        save_image_path = f"results_unet\\{name}.png"
    ...
    df.to_csv("files_unet\\score.csv")
