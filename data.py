...
if __name__ == "__main__":
    ...
    create_dir("new_data\\train\\image\\")
    create_dir("new_data\\train\\mask\\")
    create_dir("new_data\\test\\image\\")
    create_dir("new_data\\test\\mask\\")

    """ Data augmentation """
    augment_data(train_x, train_y, r"new_data\\train", augment=True)
    print("success train");
    augment_data(test_x, test_y, r"new_data\\test", augment=False)
    print("success test");
